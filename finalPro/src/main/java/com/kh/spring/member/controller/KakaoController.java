...
public class KakaoController {
	...
	public String kakaoLogin() {
		...
		loginUrl.append("93579955c5d3578c1d0e9bbe9e39cfdb");
		loginUrl.append("&redirect_uri=");
		loginUrl.append("http://localhost:8060/spring");
...
*/
	...
	public @ResponseBody String getKakaoAuthUrl(
		...
		String reqUrl = 
				...
				+ "?client_id=93579955c5d3578c1d0e9bbe9e39cfdb"
				+ "&redirect_uri=http://localhost:8060/spring/kakaoEnroll.me"
				+ "&response_type=code";
		return reqUrl;
	}
	...
	public String getAccessToken (String authorize_code) {
        ...
        try {
            ...
            sb.append("&client_id=93579955c5d3578c1d0e9bbe9e39cfdb");  //본인이 발급받은 key
            sb.append("&redirect_uri=http://localhost:8060/spring/kakaoEnroll.me");     // 본인이 설정해 놓은 경로
