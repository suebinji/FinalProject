                        ...
                        <form action="update.bo" method="post">
                            <table>
                                ...
                                <tbody>
                                    <tr>
                                        <th scope="row">제목</th>
                                        <td colspan="3"><input type="text" name="noticeTitle" value="${ notice.noticeTitle }" class="title_input" placeholder="제목을 입력해주세요."></td>
                                    </tr>
                                    <tr>
                                        ...
                                        <th scope="row">작성자</th>
                                        <td><input type="text" placeholder="작성자 닉네임" value="${ notice.m.memNickname }" class="nick_input" readonly></td>
                                    </tr>
